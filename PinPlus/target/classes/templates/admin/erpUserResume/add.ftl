...
<head>
    <meta charset="utf-8">
    <title>系统分配给用户的简历添加--${site.name}</title>
...
<form class="layui-form" style="width:80%;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="read"  lay-skin="switch" value="1" lay-text="是|否" >
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addErpUserResume)",function(data){
            ...
            $.post("${base}/admin/erpUserResume/add",data.field,function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("系统分配给用户的简历添加成功！",{time:1000},function(){
